from rest_framework import permissions #Importo los permisos del rest_framework
...
class IsOwner(permissions.BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if request.method in permissions.SAFE_METHODS: #Si está en la lista de permisos ya sea get, options, head
            return True
